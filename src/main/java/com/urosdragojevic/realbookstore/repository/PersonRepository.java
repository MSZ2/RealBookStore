...
public class PersonRepository {
    ...
    public List<Person> getAll() {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            e.printStackTrace();
            LOG.warn("Failed to retrieve persons");
        }
        return personList;
    }
    ...
    public void update(Person personUpdate) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            e.printStackTrace();
            LOG.warn("Failed to update person info: " + personUpdate.toString());
        }
        auditLogger.audit("Person info updated: " + personUpdate.toString());
    }
}
